...
export async function tryLoginPrescriber(email, password) {
    ...
    if (data) {
        const { email, firstName, lastName, language, city, province, address, profession, providerCode, licencingCollege, licenceNumber, registered } = data;
        ...
        const prescriber = new Prescriber(email, "", firstName, lastName, language, city, province, address, profession, providerCode, licencingCollege, licenceNumber, registered)
